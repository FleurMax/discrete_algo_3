...
public class ModifiedImprovedClarkeWrightAlgorithm implements VRPAlgorithm{
    ...
    private ModifiedImprovedClarkeWrightAlgorithm(Builder builder) {
    ...
    public static class Builder {
        ...
        public ModifiedImprovedClarkeWrightAlgorithm build() {
            return new ModifiedImprovedClarkeWrightAlgorithm(this);
        }
    ...
    public String getName() {
        return "Modified Improved Clarke and Wright savings algorithm (Senne)";
    }
